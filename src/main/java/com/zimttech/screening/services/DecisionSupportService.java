...
public class DecisionSupportService {
    ...
    private String getDecision(boolean needsDiabetesScreening, boolean needsBloodPressureMedication, boolean needsWeightLossCounseling, boolean needsGrowthHormoneTherapy){
        String decision = "";
